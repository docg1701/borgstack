...
- [x] **Task 1: Create Quick Start Tutorial** (AC: 1)
  ...
  - [x] **Section 0.2: Pré-Requisitos**
    ...
    - [x] Software checklist: GNU/Linux, public IP, DNS access, SSH access
...
1. **Technical Accuracy:**
   - Test all commands on clean GNU/Linux server
...
1. **Technical Accuracy Testing:**
   - Execute quick-start tutorial on clean GNU/Linux server (full walkthrough)
...
# (Manual testing on clean GNU/Linux server)
